...
def test_organization_advanced():
    """Test des nouvelles fonctionnalités avancées d'organisation"""
    
    base_url = "http://localhost:8000/api/v1/organization-advanced"
    
    print("🚀 Test des fonctionnalités avancées d'organisation")
    print("=" * 60)
